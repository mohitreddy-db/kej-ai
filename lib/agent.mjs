...
- Never repeat a failing query shape more than once. After two empty or rejected attempts, run at most one diagnostic query (coverage, ranges or name candidates) and answer with what is and is not available.
