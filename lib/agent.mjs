...
- Treat "highest buyer/customer by quantity" as actual dispatched quantity unless the user explicitly asks for ordered quantity, and state that definition.
- Treat transporter work-order quantity as assigned quantity, not delivery performance or confirmed delivered quantity.
